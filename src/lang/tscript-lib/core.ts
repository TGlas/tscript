    ...
    "impl": {
        ...
        "Boolean": {
                "constructor": function(object, value) {
                    if (! TScript.isDerivedFrom(value.type, Typeid.typeid_boolean)) this.error("/argument-mismatch/am-1", ["value", "Boolean.constructor", "boolean", TScript.displayname(value.type)]);
                    object.value.b = value.value.b;
                },
        },
        "Integer": {
                "constructor": function(object, arg) {
                    if (TScript.isDerivedFrom(arg.type, Typeid.typeid_boolean)) object.value.b = arg.value.b ? 1 : 0;
                    ...
                    else this.error("/argument-mismatch/am-1", ["value", "Integer.constructor", "boolean, integer, real, or string", TScript.displayname(arg.type)]);
                },
        },
        "Real": {
                "constructor": function(object, arg) {
                    if (TScript.isDerivedFrom(arg.type, Typeid.typeid_boolean)) object.value.b = arg.value.b ? 1 : 0;
                    else if (TScript.isDerivedFrom(arg.type, Typeid.typeid_integer) || TScript.isDerivedFrom(arg.type, Typeid.typeid_real)) object.value.b = arg.value.b;
                    else if (TScript.isDerivedFrom(arg.type, Typeid.typeid_string)) object.value.b = Number(arg.value.b);
                    else object.value.b = NaN;
                },
                "isFinite": function(object) {
                    return {"type": this.program.types[Typeid.typeid_boolean], "value": {"b": Number.isFinite(object.value.b)}};
                },
                "isInfinite": function(object) {
                    return {"type": this.program.types[Typeid.typeid_boolean], "value": {"b": object.value.b === Number.POSITIVE_INFINITY || object.value.b === Number.NEGATIVE_INFINITY}};
                },
                "isNan": function(object) {
                    return {"type": this.program.types[Typeid.typeid_boolean], "value": {"b": Number.isNaN(object.value.b)}};
                },
                "inf": function(first, second) {
                    return {"type": this.program.types[Typeid.typeid_real], "value": {"b": Infinity}};
                },
                "nan": function(first, second) {
                    return {"type": this.program.types[Typeid.typeid_real], "value": {"b": NaN}};
                },
        },
        "String": {
                "constructor": function(object, value) {
                ...
                "size": function(object) {
                    return {"type": this.program.types[Typeid.typeid_integer], "value": {"b": object.value.b.length}};
                },
                "find": function(object, searchterm, start, backward) {
                    if (! TScript.isDerivedFrom(searchterm.type, Typeid.typeid_string)) this.error("/argument-mismatch/am-1", ["searchterm", "String.find", "string", TScript.displayname(searchterm.type)]);
                    if (! TScript.isDerivedFrom(start.type, Typeid.typeid_integer)) this.error("/argument-mismatch/am-1", ["start", "String.find", "integer", TScript.displayname(start.type)]);
                    if (! TScript.isDerivedFrom(backward.type, Typeid.typeid_boolean)) this.error("/argument-mismatch/am-1", ["backward", "String.find", "boolean", TScript.displayname(backward.type)]);
                    let pos;
                    ...
                    if (pos === -1) return {"type": this.program.types[Typeid.typeid_null], "value": {"b": null}};
                    else return {"type": this.program.types[Typeid.typeid_integer], "value": {"b": pos}};
                },
                "split": function(object, separator) {
                    if (! TScript.isDerivedFrom(separator.type, Typeid.typeid_string)) this.error("/argument-mismatch/am-1", ["separator", "String.split", "string", TScript.displayname(separator.type)]);
                    let a = object.value.b.split(separator.value.b);
                    let arr = new Array();
                    for (let i=0; i<a.length; i++) arr.push({"type": this.program.types[Typeid.typeid_string], "value": {"b": a[i]}});
                    return {"type": this.program.types[Typeid.typeid_array], "value": {"b": arr}};
                },
                "fromUnicode": function(characters) {
                    ...
                    else if (TScript.isDerivedFrom(characters.type, Typeid.typeid_array))
                    {
                        for (let i=0; i<characters.value.b.length; i++)
                        {
                            ...
                            if (! TScript.isDerivedFrom(sub.type, Typeid.typeid_integer)) this.error("/argument-mismatch/am-1", ["characters", "String.fromUnicode", "integer or an array of integers", "array containing '" + TScript.displayname(sub.type) + "'"]);
                            s += String.fromCharCode(sub.value.b);
                        }
                    }
                    else this.error("/argument-mismatch/am-1", ["characters", "String.fromUnicode", "integer or an array of integers", TScript.displayname(characters.type)]);
                    return {"type": this.program.types[Typeid.typeid_string], "value": {"b": s}};
                },
        },
        "Array": {
                "constructor": function(object, size_or_other, value) {
                    ...
                    else if (TScript.isDerivedFrom(size_or_other.type, Typeid.typeid_range))
                    {
                        ...
                        {
                            object.value.b.push({"type": this.program.types[Typeid.typeid_integer], "value": {"b": i}});
                        }
                    }
                    else this.error("/argument-mismatch/am-1", ["size_or_other", "Array.constructor", "integer, an array, or a range", TScript.displayname(size_or_other.type)]);
                },
                "size": function(object) {
                    return {"type": this.program.types[Typeid.typeid_integer], "value": {"b": object.value.b.length}};
                },
                ...
                "insert": function(object, position, item) {
                    if (! TScript.isDerivedFrom(position.type, Typeid.typeid_integer)) this.error("/argument-mismatch/am-1", ["position", "Array.insert", "integer", TScript.displayname(position.type)]);
                ...
                "remove": function(object, range) {
                    ...
                    else this.error("/argument-mismatch/am-1", ["range", "Array.remove", "range or an integer", TScript.displayname(range.type)]);
                    if (a < 0) a = 0;
                    ...
                    "step": function() {
                        ...
                        if (ip === 0)
                        {
                            if (frame.object.value.b.length <= 1)
                            {
                                // trivial case
                                this.stack.pop();
                                this.stack[this.stack.length - 1].temporaries.push({"type": this.program.types[Typeid.typeid_null], "value": {"b": null}});
                                return false;
                            }
                            ...
                            else if (TScript.isDerivedFrom(frame.variables[0].type, Typeid.typeid_function) && frame.variables[0].value.b.func.params.length === 2)
                            {
                            ...
                            else this.error("/argument-mismatch/am-1", ["comparator", "Array.sort", "function of two arguments", TScript.displayname(frame.variables[0].type)]);
                        }
                        else if (ip === 1)
                        {
                        ...
                        else if (ip === 2)
                        {
                            ...
                            if (! TScript.isNumeric(result.type)) this.error("/argument-mismatch/am-19", [TScript.displayname(result.type)]);
                        ...
                        else
                        {
                            ...
                            // return null
                            ErrorHelper.assert(frame.temporaries.length === 0, "non-empty temporaries stack in return from Array.sort");
                            this.stack.pop();
                            this.stack[this.stack.length - 1].temporaries.push({"type": this.program.types[Typeid.typeid_null], "value": {"b": null}});
                            return false;
                        }
                ...
                "keys": function(object) {
                    return {"type": this.program.types[Typeid.typeid_range], "value": {"b": {"begin": 0, "end": object.value.b.length}}};
                },
                "values": function(object) {
                    return object;
                },
                "concat": function(first, second) {
                    if (! TScript.isDerivedFrom(first.type, Typeid.typeid_array)) this.error("/argument-mismatch/am-1", ["first", "Array.concat", "array", TScript.displayname(first.type)]);
                    if (! TScript.isDerivedFrom(second.type, Typeid.typeid_array)) this.error("/argument-mismatch/am-1", ["second", "Array.concat", "array", TScript.displayname(second.type)]);
                    let arr = new Array();
        ...
        "Dictionary": {
                "constructor": function(object, other) {
                    ...
                    else this.error("/argument-mismatch/am-1", ["other", "Dictionary.constructor", "null or a dictionary", TScript.displayname(other.type)]);
                },
                "size": function(object) {
                    return {"type": this.program.types[Typeid.typeid_integer], "value": {"b": Object.keys(object.value.b).length}};
                },
                "has": function(object, key) {
                    if (! TScript.isDerivedFrom(key.type, Typeid.typeid_string)) this.error("/argument-mismatch/am-1", ["key", "Dictionary.has", "string", TScript.displayname(key.type)]);
                    let ret = object.value.b.hasOwnProperty('#' + key.value.b);
                    return {"type": this.program.types[Typeid.typeid_boolean], "value": {"b": ret}};
                },
                "remove": function(object, key) {
                    if (! TScript.isDerivedFrom(key.type, Typeid.typeid_string)) this.error("/argument-mismatch/am-1", ["key", "Dictionary.remove", "string", TScript.displayname(key.type)]);
                ...
                "keys": function(object) {
                    ...
                    for (let key in object.value.b)
                    {
                        ...
                        arr.push({"type": this.program.types[Typeid.typeid_string], "value": {"b": key.substring(1)}});
                    }
                    return {"type": this.program.types[Typeid.typeid_array], "value": {"b": arr}};
                },
                "values": function(object) {
                ...
                "merge": function(first, second) {
                    if (! TScript.isDerivedFrom(first.type, Typeid.typeid_dictionary)) this.error("/argument-mismatch/am-1", ["first", "Dictionary.merge", "dictionary", TScript.displayname(first.type)]);
                    if (! TScript.isDerivedFrom(second.type, Typeid.typeid_dictionary)) this.error("/argument-mismatch/am-1", ["second", "Dictionary.merge", "dictionary", TScript.displayname(second.type)]);
                    let dict = {};
                    ...
                    return {"type": this.program.types[Typeid.typeid_dictionary], "value": {"b": dict}};
                },
        },
        "Function": {
            "constructor": function(object, value) {
                if (! TScript.isDerivedFrom(value.type, Typeid.typeid_function)) this.error("/argument-mismatch/am-1", ["value", "Function.constructor", "function", TScript.displayname(value.type)]);
                object.value.b = value.value.b;
            },
        },
        "Range": {
            "constructor": function(object, begin, end) {
                ...
                else if (TScript.isDerivedFrom(begin.type, Typeid.typeid_real) && TScript.isInt32(begin.value.b)) { }
                else this.error("/argument-mismatch/am-1", ["begin", "Range.constructor", "integer", TScript.displayname(begin.type)]);
            ...
            "begin": function(object) {
                return {"type": this.program.types[Typeid.typeid_integer], "value": {"b": object.value.b.begin}};
            },
            "end": function(object) {
                return {"type": this.program.types[Typeid.typeid_integer], "value": {"b": object.value.b.end}};
            },
        },
        "Type": {
            "constructor": function(object, value) {
            ...
            "superclass": function(type) {
                if (! TScript.isDerivedFrom(type.type, Typeid.typeid_type)) this.error("/argument-mismatch/am-1", ["type", "Type.superclass", "type", TScript.displayname(type.type)]);
                if (type.value.b.hasOwnProperty("superclass")) return {"type": this.program.types[Typeid.typeid_type], "value": {"b": type.value.b.superclass}};
                else return {"type": this.program.types[Typeid.typeid_null], "value": {"b": null}};
            },
            "isOfType": function(value, type) {
                if (! TScript.isDerivedFrom(type.type, Typeid.typeid_type)) this.error("/argument-mismatch/am-1", ["type", "Type.isOfType", "type", TScript.displayname(type.type)]);
                let ret = false;
                let sub = value.type;
            ...
            "isDerivedFrom": function(subclass, superclass) {
                if (! TScript.isDerivedFrom(subclass.type, Typeid.typeid_type)) this.error("/argument-mismatch/am-1", ["subclass", "Type.isDerivedFrom", "type", TScript.displayname(subclass.type)]);
                if (! TScript.isDerivedFrom(superclass.type, Typeid.typeid_type)) this.error("/argument-mismatch/am-1", ["superclass", "Type.isDerivedFrom", "type", TScript.displayname(superclass.type)]);
                let ret = false;
        ...
        "assert": function(condition, message) {
            if (! TScript.isDerivedFrom(condition.type, Typeid.typeid_boolean)) this.error("/argument-mismatch/am-1", ["condition", "assert", "boolean", TScript.displayname(condition.type)]);
            if (! TScript.isDerivedFrom(message.type, Typeid.typeid_string)) this.error("/argument-mismatch/am-1", ["message", "assert", "string", TScript.displayname(message.type)]);
            if (! condition.value.b) this.error("/user/ue-1", [message.value.b]);
            return {"type": this.program.types[Typeid.typeid_null], "value": {"b": null}};
        },
        "error": function(message) {
            if (! TScript.isDerivedFrom(message.type, Typeid.typeid_string)) this.error("/argument-mismatch/am-1", ["message", "error", "string", TScript.displayname(message.type)]);
            this.error("/user/ue-2", [message.value.b]);
        },
        "same": function(first, second) {
            return {"type": this.program.types[Typeid.typeid_boolean], "value": {"b": (first === second)}};
        },
        "version": function() {
            let ret = {
                        "#type":  {"type": this.program.types[Typeid.typeid_string],  "value": {"b": Version.type}},
                        "#major": {"type": this.program.types[Typeid.typeid_integer], "value": {"b": Version.major}},
                        "#minor": {"type": this.program.types[Typeid.typeid_integer], "value": {"b": Version.minor}},
                        "#patch": {"type": this.program.types[Typeid.typeid_integer], "value": {"b": Version.patch}},
                        "#day":   {"type": this.program.types[Typeid.typeid_integer], "value": {"b": Version.day}},
                        "#month": {"type": this.program.types[Typeid.typeid_integer], "value": {"b": Version.month}},
                        "#year":  {"type": this.program.types[Typeid.typeid_integer], "value": {"b": Version.year}},
                        "#full":  {"type": this.program.types[Typeid.typeid_string],  "value": {"b": Version.full()}},
                    };
        ...
        "prompt": function(text) {
            ...
            if (! this.service.documentation_mode && this.service.prompt)
            {
                ...
                if (ret === null) return {"type": this.program.types[Typeid.typeid_null], "value": {"b": null}};
                else return {"type": this.program.types[Typeid.typeid_string], "value": {"b": ret}};
            }
            else return {"type": this.program.types[Typeid.typeid_string], "value": {"b": ""}};
        },
        "wait": function(milliseconds) {
            if (! TScript.isNumeric(milliseconds.type)) this.error("/argument-mismatch/am-1", ["milliseconds", "wait", "numeric argument", TScript.displayname(milliseconds.type)]);
            if (! this.service.documentation_mode) this.wait(milliseconds.value.b);
            return {"type": this.program.types[Typeid.typeid_null], "value": {"b": null}};
        },
        "time": function() {
            return {"type": this.program.types[Typeid.typeid_real], "value": {"b": (new Date()).getTime()}};
        },
        "localtime": function() {
            let d = new Date();
            return {"type": this.program.types[Typeid.typeid_real], "value": {"b": d.getTime() - 60000.0 * d.getTimezoneOffset()}};
        },
        "exists": function(key) {
        ...
        "save": function(key, value) {
            if (! TScript.isDerivedFrom(key.type, Typeid.typeid_string)) this.error("/argument-mismatch/am-1", ["key", "save", "string", TScript.displayname(key.type)]);
            try
            {
            ...
            try
            {
                let copy = function copy(v, k)
                {
                    ...
                    else if (v.type.id === Typeid.typeid_array)
                    {
                        ...
                        return {"type": this.program.types[Typeid.typeid_array], "value": {"b": b}};
                    }
                    else if (v.type.id === Typeid.typeid_dictionary)
                    {
                        ...
                        return {"type": this.program.types[Typeid.typeid_dictionary], "value": {"b": b}};
                    }
                    else if (v.type.id === Typeid.typeid_function) throw "a function in the data structure";
        ...
        "setEventHandler": function(event, handler) {
            if (! TScript.isDerivedFrom(event.type, Typeid.typeid_string)) this.error("/argument-mismatch/am-1", ["event", "setEventHandler", "string", TScript.displayname(event.type)]);
            ...
            if (handler.type.id !== Typeid.typeid_null && ! TScript.isDerivedFrom(handler.type, Typeid.typeid_function)) this.error("/argument-mismatch/am-1", ["handler", "setEventHandler", "Null or Function", TScript.displayname(handler.type)]);
