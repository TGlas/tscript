...
export function parse_whiledo(state, parent)
{
			...
			"step": function()
					{
						...
						else if (ip === 1)
						{
							...
							if (! TScript.isDerivedFrom(cond.type,Typeid.typeid_boolean)) this.error("/argument-mismatch/am-37", [TScript.displayname(cond.type)]);
							if (cond.value.b)
							{
