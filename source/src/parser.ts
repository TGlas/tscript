...
import { create_breakpoint, scopestep } from "./runner_helper";
...
import { parse_statement_or_declaration } from "./parse_fn/parse_statmentordeclaration";

export class Parser{
    public static parse(sourcecode)
    {
